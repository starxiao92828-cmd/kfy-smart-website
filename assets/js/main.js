...
qsa('form[data-demo]').forEach(form=>form.addEventListener('submit',e=>{e.preventDefault();alert('Thanks! This demo form is ready for integration with Formspree, HubSpot, Zoho, or your CRM.')}));
